							...
							<div class="col-sm-12">
								<div class="description-block">
									...
									<div class="pull-right">
										...
										<button class="btn btn-default btn-xs btn-flat edit-button" data-id="{{ $user->id }}" data-toggle="tooltip" data-original-title="Edit" {{ is_null(is_demo_admin()) ? '' : 'disabled'}}><i class="fa fa-edit"></i></button>
										<button class="btn btn-default btn-xs btn-flat delete-button" data-id="{{ $user->id }}" data-toggle="tooltip" data-original-title="Delete" {{ is_null(is_demo_admin()) ? '' : 'disabled'}}><i class="fa fa-trash"></i></button>
									</div>
								</div>
								<!-- /.description-block -->
							</div>
