...
<a href="{{ route('dashboardRoute') }}" class="logo">
  ...
  <span class="logo-lg"><b>PPC Church</b></span>
</a>
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown user user-menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
          ...
          <img src="{{ $user->image }}" class="user-image" alt="{{ Auth::user()->name }}">
          @else
      ...
      <!-- setting -->
      <li class="user user-menu"><a href="#"><span class="hidden-xs"><i class="fa fa-gears"></i></span></a></li>
      <!-- /.setting -->
