            ...
            <div class="about-us">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <a href="{{ route('dashboard.dashboardPage') }}" class="btn btn-primary pull-right btn-flat"><i
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <form data-parsley-validate name="profile_edit_form"
                              action="{{ route('dashboard.updatePprofilePage', $user->id) }}" method="post"
                        ...
                        <strong>{{ $errors->first('name') }}</strong>
                            ...
                            <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="username" class="form-control" id="username"
                                       value="{{ $user->username }}" placeholder="ex: username">
                        ...
                        <strong>{{ $errors->first('username') }}</strong>
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <input type="email" name="email" class="form-control" id="email"
                                       value="{{ $user->email }}" placeholder="ex: example@gmail.com">
                                @if ($errors->has('email'))
                                    <span class="help-block">
                        <strong>{{ $errors->first('email') }}</strong>
                            ...
                            <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                ...
                                <input id="phone" type="text" name="phone" class="form-control"
                                       value="{{ $user->phone }}" required maxlength="25"
                            ...
                            <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <input id="address" type="text" name="address" class="form-control"
                                       value="{{ $user->address }}" required maxlength="250" placeholder="ex: address">
                            ...
                            <div class="form-group{{ $errors->has('facebook') ? ' has-error' : '' }}">
                                ...
                                <input id="facebook" type="text" name="facebook" class="form-control"
                                       value="{{ $user->facebook }}" maxlength="250"
                            ...
                            <div class="form-group{{ $errors->has('twitter') ? ' has-error' : '' }}">
                                ...
                                <input id="twitter" type="text" name="twitter" class="form-control"
                                       value="{{ $user->twitter }}" maxlength="250"
                            ...
                            <div class="form-group{{ $errors->has('google_plus') ? ' has-error' : '' }}">
                                ...
                                <input id="google_plus" type="text" name="google_plus" class="form-control"
                                       value="{{ $user->google_plus }}" maxlength="250"
                                       placeholder="ex: https://plus.google.com">
                            ...
                            <div class="form-group{{ $errors->has('linkedin') ? ' has-error' : '' }}">
                                ...
                                <input id="linkedin" type="text" name="linkedin" class="form-control"
                                       value="{{ $user->linkedin }}" maxlength="250"
                            ...
                            <div class="form-group{{ $errors->has('about') ? ' has-error' : '' }}">
                                ...
                                <textarea name="about" rows="5" class="form-control" required maxlength="260"
                                          placeholder="ex: about me">{{ $user->about }}</textarea>
                                @if ($errors->has('about'))
                                    <span class="help-block">
                            ...
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-primary" {{ !empty(is_demo()) ? 'disabled' : '' }}>Update</button>
                            </div>
                        </form>
                    </div>
                </div>
