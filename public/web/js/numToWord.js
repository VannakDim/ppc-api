...
function generateWords(number) {
    ...
    if (number < 10) {
        ...
        word = generateWords(Math.floor(number / TEN_THOUSAND)) + 'ម៉ឺន ';

    } else if (number < ONE_BILLION) {
        remainder = number % ONE_MILLION;
        word = generateWords(Math.floor(number / ONE_MILLION)) + 'លាន ';

    } else if (number < ONE_TRILLION) {
        remainder = number % ONE_BILLION;
        word = generateWords(Math.floor(number / ONE_BILLION)) + 'ពាន់លាន ';

    } else if (number < ONE_QUADRILLION) {
        remainder = number % ONE_TRILLION;
        word = generateWords(Math.floor(number / ONE_TRILLION)) + 'ទ្រីលាន ';
